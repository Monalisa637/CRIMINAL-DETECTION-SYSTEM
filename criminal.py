...
class Criminal:
    ...
    #vaeiables
        ...
        img1=img1.resize((1530,200),Image.LANCZOS)
        ...
        # upper Frame
        upper_frame=LabelFrame(Main_frame,bd=2,relief=RIDGE,text='CRIMINAL REGISTRATION ',font=('times new roman',20,'bold'),fg='black')
        ...
        btn_train=Button(Button_frame,command=self.train_classifier,text="Save photo",font=('arial',11,'bold'),bg='black',width=13,fg="white",height="1")
        ...
        # Lower Frame
        down_frame=LabelFrame(Main_frame,bd=2,relief=RIDGE,text='CRIMINAL INFORMATION',font=('times new roman',15,'bold'),fg='black')
   ...
   # def fetch_data
    ...
    def train_classifier(self):
        ...
        cv2.destroyAllWindows()
        messagebox.showinfo("Result","saving datasets completed !!")    
